...
public class PetMeetVoiceCatalog {
    ...
    private static final Map<String, Map<Kind, MeetClip>> BY_SLUG = Map.of(
            "raiden", Map.of(
                    Kind.MEET, clip("raiden", Kind.MEET, "……我是雷电将军。初次见面，请多指教。"),
            ...
            "ayaka", Map.of(
                    Kind.MEET, clip("ayaka", Kind.MEET, "初次见面，我是神里绫华，还请您多多关照。"),
            ...
            "ganyu", Map.of(
                    Kind.MEET, clip("ganyu", Kind.MEET, "你好，我是璃月七星的甘雨，初次见面，请多指教。"),
            ...
            "klee", Map.of(
                    Kind.MEET, clip("klee", Kind.MEET, "哇！我是火花骑士可莉，初次见面请多指教！"),
            ...
            "elysia", Map.of(
                    Kind.MEET, clip("elysia", Kind.MEET, "嗨～我是爱莉希雅，很高兴遇见你，请多关照哦。"),
