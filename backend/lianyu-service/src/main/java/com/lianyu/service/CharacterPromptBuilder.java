...
import com.lianyu.service.tools.ToolFactBundle;
...
public class CharacterPromptBuilder {
    ...
    public String buildSystemPrompt(Character character, String memoryContext) {
        return buildSystemPrompt(character, memoryContext, "zh");
    }
    ...
    public String buildSystemPrompt(Character character, String memoryContext, String outputLanguage) {
        ...
        ToolFactBundle facts = toolManager.collectFacts(settings);
        String factBlock = facts.toPromptBlock();
        if (!factBlock.isBlank()) {
            prompt += "\n\n" + factBlock;
        }
    ...
    private String extractPersona(String name, Map<String, Object> settings) {
        ...
        String personality = (String) settings.getOrDefault("personality", "");
        String speakingStyle = (String) settings.getOrDefault("speakingStyle", "");
        String backstory = (String) settings.getOrDefault("backstory", "");
