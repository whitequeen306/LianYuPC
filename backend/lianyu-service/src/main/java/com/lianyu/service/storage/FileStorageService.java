...
public class FileStorageService {
    ...
    private static final Pattern SAFE_OBJECT_KEY = Pattern.compile(
            "^(avatars/[a-zA-Z0-9._-]+|chat-images/[a-zA-Z0-9._-]+|community-images/[a-zA-Z0-9._-]+|chat-voice/[a-z0-9-]+/[a-zA-Z0-9._-]+|custom-voices/[0-9]+/[a-zA-Z0-9._-]+|square-avatars/[a-z0-9._-]+|square-avatars-thumb/[a-z0-9._-]+|updates/(latest\\.yml|agent-latest\\.yml|wechat-channel-latest\\.yml|[a-zA-Z0-9._-]+\\.exe|[a-zA-Z0-9._-]+\\.exe\\.blockmap|AgentEngine-hosted-win-x64-[0-9]+\\.[0-9]+\\.[0-9]+\\.zip|WechatChannel-win-x64-[0-9]+\\.[0-9]+\\.[0-9]+\\.zip))$"
    );
    ...
    public String resolveSafePublicContentType(String objectKey, String storedContentType) {
        ...
        if (lowerKey.equals(UPDATES_PATH + "latest.yml")
                ...
                || lowerKey.equals(UPDATES_PATH + "wechat-channel-latest.yml")) {
            return "text/yaml";
        }
        return "application/octet-stream";
    }
    ...
    private String guessContentTypeFromKey(String objectKey) {
        ...
        if (lower.equals(UPDATES_PATH + "latest.yml")
                || lower.equals(UPDATES_PATH + "agent-latest.yml")
                || lower.equals(UPDATES_PATH + "wechat-channel-latest.yml")) return "text/yaml";
        if (lower.endsWith(".png")) return "image/png";
        if (lower.endsWith(".webp")) return "image/webp";
        if (lower.endsWith(".gif")) return "image/gif";
        return "image/jpeg";
