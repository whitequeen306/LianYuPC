...
import { fetchAdminList, createRelease, moderateUser } from '../api'
...
configs.users.columns=[['id','ID'],['username','账号'],['nickname','昵称'],['admin_status','状态'],['created_at','创建时间']]
