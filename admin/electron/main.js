...
function createWindow() {
  win = new BrowserWindow({ width: 1380, height: 860, minWidth: 1080, minHeight: 680, frame: false, backgroundColor: '#0e1218', title: 'LianYu Admin', webPreferences: { preload: path.join(root, 'preload.js'), contextIsolation: true, nodeIntegration: false } })
