  ...
  <div class="landing">
    ...
    <header class="landing-nav" :class="{ 'landing-nav--scrolled': navScrolled }">
      <div class="landing-nav__inner">
        <button type="button" class="landing-nav__brand" @click="scrollTo('hero')">
          <img :src="APP_LOGO" alt="予念 YuNian" class="landing-nav__logo" />
          <span class="landing-nav__wordmark">
            <span class="landing-nav__title">予念</span>
            <span class="landing-nav__sub">YuNian</span>
          </span>
        </button>
      ...
      <div class="section__inner">
        <header class="section__head reveal">
          ...
          <p class="section__desc">
            从第一句问候到长期记忆，予念把陪伴拆成可感知的体验——而不是冰冷的对话框。
          </p>
        </header>
    ...
    <footer class="landing-footer">
      <div class="landing-footer__inner">
        ...
        <p class="landing-footer__copy">© {{ year }} YuNian · 陪伴，而非打扰</p>
      </div>
    </footer>
  </div>
</template>
