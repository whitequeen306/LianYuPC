export default {
  ...
  qqBridge: {
    ...
    reply: { title: '回覆設定', segmentDelay: '分段傳送延遲', segmentDelayHint: 'AI 回覆拆成多條逐條傳送的條間間隔，0 為不延遲（毫秒）', segmentJitter: '隨機抖動', segmentJitterHint: '在分段延遲基礎上附加 0~該值的隨機量，讓間隔不固定以降低風控，0 為不抖動（毫秒）', fallback: '兜底回覆', fallbackHint: '雲端異常/逾時時代替 AI 回覆的內容，留空則不兜底', save: '儲存', saved: '已儲存', applyHint: '儲存後對下一條訊息生效（無需重啟橋接）' },
