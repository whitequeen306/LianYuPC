export default {
  ...
  about: {
    ...
    mcpUseDemo: '使用內建演示服務',
    mcpCommand: '引擎命令',
    mcpCommandPlaceholder: '打包版填 exe 路徑，如 C:\\AgentAssistant\\engine.exe；原始碼除錯填 python',
    mcpCommandHint: '留空則使用已下載的 AgentEngine。自訂時填可執行檔路徑；原始碼方式請把工作目錄設為 AgentAssistant 倉庫根。',
    mcpArgs: '啟動參數（每行一個）',
    mcpArgsPlaceholder: '原始碼除錯範例：\n-m\nagent_assistant.hosted.mcp_server',
    mcpArgsHint: '每行一個參數。打包版通常留空；原始碼方式填 -m 與模組名兩行。',
    mcpCwd: '工作目錄（可選）',
    mcpCwdPlaceholder: '例如 C:\\Users\\hp\\Desktop\\AgentAssistant',
    mcpDisabledHint: '開啟後會下載並啟動本機 AgentEngine（約 60MB），把它的工具註冊給雲端角色。危險操作會先彈窗確認。',
    mcpStateRunning: '運行中',
