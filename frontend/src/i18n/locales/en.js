export default {
  ...
  qqBridge: {
    ...
    reason: { not_auto_mode: 'Enable auto-hosting above first', not_consented: 'Complete QQ hosting consent first', start_failed: 'Start failed; please check your network and retry', reinstall_failed: 'Reinstall failed; please retry or check your network', not_running: 'Runtime not ready; please start hosting first', no_conversation: 'Please select a conversation in Message Routing below first', not_logged_in: 'Please log in to your YuNian account first', disabled: 'The bridge is disabled', qqnt_not_found: 'QQ desktop (QQNT) not detected. Please install it before enabling auto-hosting: https://im.qq.com/index/', exception: 'Operation error; please retry', unknown: 'Operation failed; please retry' }
  },
  wechatBridge: {
    desc: 'Chat with your bound YuNian character from WeChat ClawBot on your phone. PC WeChat often has no entry; scan with your phone. This does not install Node or run the OpenClaw agent.',
    notElectron: 'The WeChat ClawBot channel is only available in the desktop client.',
    consent: {
      title: 'Enable WeChat ClawBot',
      body: 'The app will download YuNian’s local channel runtime and start it. Scan with your own WeChat to sign in to ClawBot. Credentials stay on this PC. Replies come from your bound YuNian chat, not the OpenClaw agent.',
    ...
    reason: {
      not_logged_in: 'Please log in to your YuNian account first',
  ...
  characters: {
    ...
    import: 'Import',
    dialogImport: 'Import character',
    importHint: 'Upload a persona card or chat log. Your own model extracts personality. Chat history is not imported.',
    importSource: 'Persona or chat log',
    importSourcePlaceholder: 'Paste a persona, or a WeChat / QQ / character-card chat export…',
    importSourceHint: 'txt / md / json / html, max 2MB. Both persona and chat logs are only used to extract personality.',
    importPickFile: 'Choose file',
    importAvatar: 'Avatar',
    importChangeAvatar: 'Change avatar',
    importPickAvatar: 'Choose image',
    importAvatarHint: 'JPG/PNG/WebP · max 8MB',
    cancel: 'Cancel',
    importAddressing: 'Usual form of address',
    importAddressingPlaceholder: 'e.g. you, idiot, commander',
    importAddressingHint: 'How this character most often addresses you. A tone hint, not required in every line.',
    importNeedSource: 'Upload or paste a persona / chat log',
    importNeedAddressing: 'Enter the character’s usual form of address',
    importNeedModel: 'No text model configured. Add one in Settings first.',
    importFileType: 'Please choose a text file (txt / md / json / html)',
    importFileTooLarge: 'File must be 2MB or smaller',
    importAnalyzing: 'Extracting character…',
    importSuccess: 'Imported character “{name}”'
  },
  cityMode: {
  ...
  settings: {
    ...
    aiDesc: 'You must configure your own API URL, key, and model to chat. Built-in platform text model is disabled.',
    addConfig: 'Add config',
    emptyTitle: 'No text model configured',
    emptyDesc: 'No text model configured. Add at least one config to chat, group chat, or use QQ bridge.',
  ...
  about: {
    ...
    envWeb: 'Web',
    envDesktop: 'Desktop',
    intro: 'YuNian is a multi-character AI companion app supporting character chat, moments, diary, memory, and a desktop pet. Runs on Windows desktop and can relay QQ messages to the cloud AI via the QQ bridge (beta).',
    techStack: 'Tech stack',
    techStackDesc: 'Frontend: Vue 3 + Element Plus + Electron; Backend: Spring Boot + MyBatis-Plus + MySQL.',
    copyright: '© 2026 YuNian',
    backToSettings: 'Back to settings',
    mcpTitle: 'MCP Services (Experimental)',
    mcpAgentAssistantDesc: 'Local computer assistant: when enabled, characters can use tools on your PC during chat (launch apps, organize files, etc.). Dangerous operations always ask for your confirmation first.',
    mcpBridge: 'Cloud bridge',
    mcpBridgeOnline: 'Connected (characters can use local tools)',
    mcpBridgeOffline: 'Not connected',
    mcpTools: 'Available tools',
    mcpEngine: 'Engine',
    mcpEngineOfficial: 'Official AgentEngine',
    mcpEngineLocal: 'Local source',
    mcpEngineOfficialHint: 'Uses the official engine YuNian distributes. It downloads when you enable computer control.',
    mcpEngineLocalHint: 'Runs the AgentAssistant repo on this machine. Restart computer control after editing source.',
    mcpEngineLocalRunning: 'Local source ({command})',
    mcpEngineManaged: 'AgentEngine {version}',
    mcpEngineNotInstalled: 'Not installed (will download from the cloud when enabled)',
    ...
    mcpCommand: 'Python interpreter',
    mcpCommandPlaceholder: 'e.g. C:\\Users\\hp\\AppData\\Local\\Programs\\Python\\Python311\\python.exe',
    mcpCommandHint: 'Set the working directory to the AgentAssistant repo root.',
    mcpArgs: 'Launch arguments (one per line)',
    mcpArgsPlaceholder: '-m\nagent_assistant.hosted.mcp_server',
    mcpArgsHint: 'For source: -m and agent_assistant.hosted.mcp_server on two lines.',
    mcpCwd: 'Working directory',
    mcpCwdPlaceholder: 'e.g. C:\\Users\\hp\\Desktop\\AgentAssistant',
    mcpDisabledHint: 'When enabled, the app downloads and starts the official AgentEngine (~60MB) and registers its tools with your cloud characters. Dangerous operations always ask first.',
    mcpDisabledHintLocal: 'When enabled, YuNian starts AgentAssistant from the Python path above. Turn computer control off and on again after editing source.',
