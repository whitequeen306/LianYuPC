export default {
  ...
  about: {
    ...
    mcpEngineOfficialHint: 'Uses the official engine LianYu distributes. It downloads when you enable computer control.',
    ...
    mcpDisabledHintLocal: 'When enabled, LianYu starts AgentAssistant from the Python path above. Turn computer control off and on again after editing source.',
