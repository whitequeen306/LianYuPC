export default {
  ...
  about: {
    ...
    mcpEngine: 'Engine',
    mcpEngineDemo: 'Built-in demo service',
    ...
    mcpCommandPlaceholder: 'Packaged: exe path e.g. C:\\AgentAssistant\\engine.exe; from source: python',
    mcpCommandHint: 'Leave empty to use the downloaded AgentEngine. Otherwise set an executable path; for source runs, set the working directory to the AgentAssistant repo root.',
    mcpArgs: 'Launch arguments (one per line)',
    mcpArgsPlaceholder: 'Source example:\n-m\nagent_assistant.hosted.mcp_server',
    mcpArgsHint: 'One argument per line. Usually empty for the packaged build; for source, put -m and the module name on two lines.',
    mcpCwd: 'Working directory (optional)',
    mcpCwdPlaceholder: 'e.g. C:\\Users\\hp\\Desktop\\AgentAssistant',
    mcpDisabledHint: 'When enabled, the app downloads and starts the local AgentEngine (~60MB) and registers its tools with your cloud characters. Dangerous operations always ask first.',
