export default {
  ...
  qqBridge: {
    ...
    status: { title: '実行状態' },
    binding: { title: 'メッセージルーティング', character: 'AI キャラクター', characterPlaceholder: 'AI キャラクターを選択', characterEmpty: 'キャラクターがありません。先に YuNian アプリで作成してください', characterHint: '選択後、ブリッジは各 QQ ユーザーごとに該当キャラの専用会話を自動マッチング（会話 ID の手入力不要）。コンテキストを消去して会話が無効になっても自動再構築され、影響を受けません。', provider: 'テキスト Provider', providerHint: 'プラットフォーム既定は共有 Key。自分の Provider を選ぶと QQ もその設定・モデルを使います。', model: 'テキストモデル', modelPlaceholder: 'プラットフォーム既定では不要', modelHint: 'カスタム Provider のみ変更可。空ならその Provider の既定モデル。', conversationId: 'クラウド会話', conversationIdHint: '初回ブリッジ起動時に最近の1対1会話を自動バインド（全自動）；別の AI を使うなら上のドロップダウンで選択。', convPlaceholder: '会話を選択', convEmpty: '会話がありません', convCreate: 'デフォルト会話を作成', convCreateOk: 'デフォルト会話を作成・バインドしました', convCreateFail: '会話の作成に失敗しました。再試行してください', noCharacter: '先に YuNian アプリでキャラクターを作成してください', currentlyBound: '現在のバインド', singleFallback: '1対1 #{id}', allowMode: 'アクセスモード', allowModeAllowlist: '許可リスト（デフォルト拒否）', allowModeOpen: 'オープン（誰でも）', openModeWarning: '⚠️ オープンモードは AI が人を間違え・コンテキストが混乱します', openModeWarningDesc: '誰でも AI 返信をトリガーでき、異なる QQ ユーザーのメッセージが混ざり、AI が人を間違えたりコンテキストが乱れます。許可リストモードに戻し、下に QQ 番号（個チャット）とグループ番号をカンマ区切りで入力することを強く推奨します。', emptyAllowlistWarning: '許可リストが空：QQ メッセージは AI に転送されません。下部に QQ 番号/グループ番号を追加してください。', allowUsers: '個チャット許可リスト（QQ番号）', allowGroups: 'グループ許可リスト（グループ番号）', allowHint: '許可リストモードでは空欄 = 転送なし；複数はカンマ区切り', save: 'ルーティング保存', saved: 'ルーティングを保存しました', pickByCharacter: 'キャラクター名で取得', pickCharacterTitle: 'AI キャラクターを選択', pickCharacterHint: '該当キャラの1対1会話を検索または新規作成してバインド', pickConfirm: '取得してバインド', pickOk: '該当キャラの会話をバインドしました', pickFail: '会話の取得に失敗しました。再試行してください' },
    ...
    reason: { not_auto_mode: '先に自動ホスティングを有効にしてください', not_consented: '先に QQ ホスティングの同意を完了してください', start_failed: '起動失敗、ネットワークを確認して再試行してください', reinstall_failed: '再インストール失敗、再試行するかネットワークを確認してください', not_running: 'ランタイムが準備されていません、先にホスティングを開始してください', no_conversation: '下の「メッセージルーティング」で会話を選択してください', not_logged_in: '先に予念アカウントにログインしてください', disabled: 'ブリッジは無効です', qqnt_not_found: 'QQ デスクトップ版（QQNT）が検出されません。自動ホスティング前にインストールしてください：https://im.qq.com/index/', exception: '操作エラー、再試行してください', unknown: '操作に失敗しました、再試行してください' }
  },
  wechatBridge: {
    desc: 'スマホの WeChat ClawBot から、紐付けた予念キャラとチャットします。PC版 WeChat では入口が見えないことが多いので、スマホでスキャンしてください。本機に Node は入れず、OpenClaw 付属エージェントも起動しません。',
    notElectron: 'WeChat ClawBot チャネルはデスクトップ版でのみ利用できます。',
    consent: {
      title: 'WeChat ClawBot を有効化',
      body: 'アプリは予念が梱包したローカルランタイムをダウンロードして起動します。自分の WeChat で ClawBot にログインしてください。資格情報はこの PC にのみ保存されます。返信は OpenClaw 付属エージェントではなく、紐付けた予念会話からです。',
      confirm: '了解して有効化',
      cancel: 'キャンセル'
    },
    status: {
    ...
    reason: {
      not_logged_in: '先に予念アカウントにログインしてください',
  ...
  auth: {
    ...
    welcomeBack: 'おかえりなさい',
    loginDesc: 'YuNian にログインして会話を続けましょう',
  ...
  characters: {
    ...
    unread: '未読あり',
    import: 'インポート',
    dialogImport: 'キャラをインポート',
    importHint: '設定資料またはチャット履歴をアップロードし、自分のモデルで性格を抽出します。会話履歴は取り込みません。',
    importSource: '設定またはチャット履歴',
    importSourcePlaceholder: '設定文、または LINE / キャラカードの履歴を貼り付け…',
    importSourceHint: 'txt / md / json / html、最大 2MB。どちらも性格抽出にだけ使います。',
    importPickFile: 'ファイルを選択',
    importAvatar: 'アバター',
    importChangeAvatar: 'アバターを変更',
    importPickAvatar: '画像を選択',
    importAvatarHint: 'JPG/PNG/WebP · 最大 8MB',
    cancel: 'キャンセル',
    importAddressing: 'よく使う呼び方',
    importAddressingPlaceholder: '例：あなた、バカ、指揮官',
    importAddressingHint: 'このキャラがあなたを呼ぶとき一番多い呼び方。口調の参考で、毎文必須ではありません。',
    importNeedSource: '設定またはチャット履歴をアップロード／貼り付けてください',
    importNeedAddressing: 'よく使う呼び方を入力してください',
    importNeedModel: 'テキストモデルが未設定です。先に設定で追加してください',
    importFileType: 'テキストファイルを選んでください（txt / md / json / html）',
    importFileTooLarge: 'ファイルは 2MB 以下にしてください',
    importAnalyzing: 'キャラ設定を抽出中…',
  ...
  about: {
    ...
    envWeb: 'ウェブ版',
    envDesktop: 'デスクトップ版',
    intro: '予念（YuNian）はマルチキャラクター AI 伴侣アプリです。キャラチャット・モーメンツ・日記・記憶・デスクトップペットをサポート。Windows デスクトップで利用可能、QQ ブリッジ（beta）で QQ メッセージをクラウド AI に転送できます。',
    techStack: '技術スタック',
    techStackDesc: 'フロントエンド Vue 3 + Element Plus + Electron；バックエンド Spring Boot + MyBatis-Plus + MySQL。',
    copyright: '© 2026 予念 YuNian',
    backToSettings: '設定に戻る',
    mcpTitle: 'MCP サービス（実験的）',
    mcpAgentAssistantDesc: 'ローカル PC アシスタント：有効にすると、キャラクターがチャット中にあなたの PC のツール（アプリ起動、ファイル整理など）を使えます。危険な操作は必ず確認ダイアログを表示します。',
    mcpBridge: 'クラウドブリッジ',
    mcpBridgeOnline: '接続済み（キャラクターがローカルツールを使用可能）',
    mcpBridgeOffline: '未接続',
    mcpTools: '利用可能なツール',
    mcpEngine: 'エンジン',
    mcpEngineOfficial: '公式 AgentEngine',
    mcpEngineLocal: 'ローカルソース',
    mcpEngineOfficialHint: '予念が配布する公式エンジンを使います。パソコン操作を有効にするとダウンロードします。',
    mcpEngineLocalHint: 'この PC の AgentAssistant リポジトリで動かします。ソースを直したらパソコン操作を再起動してください。',
    mcpEngineLocalRunning: 'ローカルソース（{command}）',
    mcpEngineManaged: 'AgentEngine {version}',
    mcpEngineNotInstalled: '未インストール（有効化時にクラウドからダウンロード）',
    ...
    mcpCommand: 'Python インタプリタ',
    mcpCommandPlaceholder: '例：C:\\Users\\hp\\AppData\\Local\\Programs\\Python\\Python311\\python.exe',
    mcpCommandHint: '作業ディレクトリは AgentAssistant のリポジトリルートです。',
    mcpArgs: '起動引数（1 行に 1 つ）',
    mcpArgsPlaceholder: '-m\nagent_assistant.hosted.mcp_server',
    mcpArgsHint: 'ソース実行は -m と agent_assistant.hosted.mcp_server の 2 行。',
    mcpCwd: '作業ディレクトリ',
    mcpCwdPlaceholder: '例：C:\\Users\\hp\\Desktop\\AgentAssistant',
    mcpDisabledHint: '有効にすると公式 AgentEngine（約 60MB）をダウンロードして起動し、そのツールをクラウドのキャラクターに登録します。危険な操作は必ず確認します。',
    mcpDisabledHintLocal: '有効にすると上の Python パスで本機の AgentAssistant ソースを起動します。ソースを直したらパソコン操作を一度オフにしてからオンにしてください。',
    mcpStateRunning: '実行中',
