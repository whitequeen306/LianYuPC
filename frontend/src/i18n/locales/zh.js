export default {
  ...
  about: {
    ...
    mcpEngineLocal: '本地源码',
    mcpEngineOfficialHint: '使用恋语云端分发的官方引擎，开启电脑操控时自动下载更新。',
