export default {
  ...
  qqBridge: {
    ...
    reply: { title: '回复设置', segmentDelay: '分段发送延迟', segmentDelayHint: 'AI 回复拆成多条逐条发送的条间间隔，0 为不延迟（毫秒）', segmentJitter: '随机抖动', segmentJitterHint: '在分段延迟基础上附加 0~该值的随机量，让间隔不固定以降低风控，0 为不抖动（毫秒）', fallback: '兜底回复', fallbackHint: '云端异常/超时时代替 AI 回复的内容，留空则不兜底', save: '保存', saved: '已保存', applyHint: '保存后对下条消息生效（无需重启桥接）' },
